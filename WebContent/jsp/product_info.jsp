	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<form id="MyForm" action="CartServlet?method=addCartItemToCart" method="post">
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								...
								<a href="javascript:void(0)">
									<input id="addCart" style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button">
								</a> &nbsp;收藏商品</div>
						</div>
					</div>
				</form>
