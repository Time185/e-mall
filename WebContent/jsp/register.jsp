...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" action="UserServlet?method=userRegist" method="post" style="margin-top:5px;">
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" name="telephone" class="form-control" id="usercaption" placeholder="请输入电话号码">
			    </div>
			  </div>
			 <div class="form-group">
